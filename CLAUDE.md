...
- **Current plan (25–30/07)**: ① stop paying for pods — every remaining question is either closed or portal-only; ② ask BTC about the median-vs-maximum rule, the `tokens_per_sec` definition, and the long-context probe threshold; ③ lock a final-5 of clean stock-vLLM configs (020, 024, plus 018 as bf16 insurance) that pass hậu kiểm without argument; ④ spend leftover slots re-running 020 only if the forum confirms best-of semantics. Do not revisit any row in the table above.
